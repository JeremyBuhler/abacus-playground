...
This section introduces Abacus search options. For more information see the [Search syntax](search.html) page.
...
For more detail and  additional tips, refer to the [Search syntax page](search.html).
